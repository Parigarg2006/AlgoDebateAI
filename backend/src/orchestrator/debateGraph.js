...
async function refinerNode(state) {
  ...
  if (!refined || !refined.finalCode || isCodeEmptyOrPlaceholder(refined.finalCode, lang)) {
    ...
    refined = {
      ...
      strategy: cleanMarkdownText(refined?.strategy || 'No mathematical strategy proof generated for this solution run.'),
    ...
    refined.strategy = cleanMarkdownText(refined.strategy || 'No mathematical strategy proof generated for this solution run.');
